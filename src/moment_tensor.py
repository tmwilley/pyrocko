...
def _tpb2q(t, p, b):
    ...
    if tqw > eps:
        ...
        q[1:] = t[1] - p[0], b[0] + t[2], b[1] + t[2]
    else:
        print 'e'
        q[0] = max(0.5 * math.sqrt(tqx), epsilon)
        q[1:] = p[2] - b[1], p[0] + t[1], b[0] + t[2]
...
_pbt2ptb = num.matrix(((1., 0., 0.), (0., 0., 1.), (0., 1., 0.)))
...
def kagan_angle(mt1, mt2):
    ...
    ai = _pbt2ptb * mt1._m_eigenvecs.T
    aj = _pbt2ptb * mt2._m_eigenvecs.T
